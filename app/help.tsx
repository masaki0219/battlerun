...
const feedbackSection: LegalSection[] = isFeedbackConfigured() ? [
  { heading: '評価・ご要望を送る', body: 'アプリの評価やご要望を、アプリ内から直接開発者へ送れます。返信が必要な不具合報告は、下のお問い合わせ窓口をご利用ください。', action: { label: '評価・ご要望を送る', route: '/feedback' } },
] : [];

export default function HelpScreen() {
  return <LegalDocument title="ヘルプ・お問い合わせ" updatedAt="2026年7月21日" sections={[
