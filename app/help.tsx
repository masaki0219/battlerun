...
export default function HelpScreen() {
  return <LegalDocument title="ヘルプ・お問い合わせ" updatedAt="2026年7月20日" sections={[
    ...
    { heading: 'お問い合わせ窓口', body: '不具合の報告、ご意見、ご要望はZELIOサポートのGitHub Issuesで受け付けています。アカウントのパスワードやGPSルートなどの秘密情報は投稿しないでください。', action: { label: 'ZELIOサポートへ問い合わせる', url: SUPPORT_CONTACT_URL } },
