...
export default function HelpScreen() {
  return <LegalDocument
    ...
    sections={[
    { heading: '記録が増えない', body: 'GPSモードでは位置情報を許可し、空が見える場所で開始してください。歩数モードは端末のモーションセンサー対応が必要です。通信できない場合も記録は端末に保管され、次回オンライン時に再送されます。開催中のチャレンジには結果確定前に再送できた場合に加算され、確定後は個人記録だけに保存されます。' },
